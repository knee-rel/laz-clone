    ...
    return(
        <main class='my-8'>
            <div className='container mx-auto px-6'>        
                <h3 className='text-gray-700 text-2xl font-medium'>New Arrivals</h3>
                <span className='mt-3 text-sm text-gray-500'>50+ Results</span>   
                <div className='grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-6'>
                    ...
                    <div className="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                        <div className="flex items-end justify-end h-56 w-full bg-cover">
                            ...
                            <button className= 'content-evenly border border-gray-200 bg-gray-200 text-gray-700 rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:bg-gray-300 focus:outline-none focus:shadow-outline'>View Product</button>
                        </div>
                    ...
                    <div className="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                        ...
                        <div className="px-5 py-3">
                            <h3 className="text-gray-700 uppercase">Airforce 1</h3>
                            <span className="text-gray-500 mt-2">$12</span>
                        </div>
                    </div>
