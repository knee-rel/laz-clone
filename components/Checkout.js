        ...
        <div className="flex-1">
          <table className="w-full text-sm lg:text-base" cellspacing="0">
            ...
            <tbody>
              ...
              <td>
                  <a>
                    <p class="mb-2 md:ml-4">Smocked Top</p>
              ...
              <td class="hidden text-right md:table-cell">
                <span class="text-sm lg:text-base font-medium">P10.00</span>
              </td>
              <td class="text-right">
                <span class="text-sm lg:text-base font-medium">P20.00</span>
              </td>
            </tbody>
          </table>
            ...
            <div className="lg:px-2 lg:w-1/2">
              ...
              <div className="p-4">
                ...
                <div class="flex justify-between border-b">
                  <div class="lg:px-4 lg:py-2 m-2 text-lg lg:text-xl font-bold text-center text-gray-800">Subtotal</div>
                  <div class="lg:px-4 lg:py-2 m-2 lg:text-lg font-bold text-center text-gray-900">P499</div>
                </div>
                <div class="flex justify-between pt-4 border-b">
                  ...
                  <div className="lg:px-4 lg:py-2 m-2 lg:text-lg font-bold text-center text-green-700">-P150</div>
                </div>
                <div className="flex justify-between pt-4 border-b">
                  <div className="lg:px-4 lg:py-2 m-2 text-lg lg:text-xl font-bold text-center text-gray-800">
                    New Subtotal
                  </div>
                  <div className="lg:px-4 lg:py-2 m-2 lg:text-lg font-bold text-center text-gray-900">P250</div>
                </div>
                <div className="flex justify-between pt-4 border-b">
                  <div className="lg:px-4 lg:py-2 m-2 text-lg lg:text-xl font-bold text-center text-gray-800">
                    Total
                  </div>
                  <div className="lg:px-4 lg:py-2 m-2 lg:text-lg font-bold text-center text-gray-900">P200</div>
                </div>
                <a href="#">
