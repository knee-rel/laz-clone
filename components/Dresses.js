    ...
    return(
        <main class='my-8'>
            <div className='container mx-auto px-6'>        
                <h3 className='text-gray-700 text-2xl font-medium'>Dresses</h3>
                <span className='mt-3 text-sm text-gray-500'>60+ Results</span>   
                <div className='grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-6'>
                    ...
                    <div className="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                        ...
                        <div className="px-5 py-3">
                            <h3 className="text-gray-700 uppercase">Smocked Dress</h3>
                            <span className="text-gray-500 mt-2">$12</span>
                        </div>
                    </div>
