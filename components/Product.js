            ...
            <div className='container mx-auto px-6'>
                <div className='md:flex md:items-center'>
                    <div className='w-full h-64 md:w-1/2 lg:h-96'>
                        <img class='h-ful w-full rounded-md object-cover max-w-lg mx-auto' src='' alt = 'productone'/>
                    </div>
                    <div className='w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2'>
                        <h3 className='text-gray-700 uppercase text-lg'>Product One</h3>
                        ...
                        <div className="mt-3">
                            ...
                            <div className="flex items-center mt-1">
                                ...
                                <button className="h-5 w-5 rounded-full bg-red-600 mr-2 focus:outline-none"></button>
